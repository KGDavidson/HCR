...
class TopMonth extends StatefulWidget {
  @override
  _TopMonthState createState() => _TopMonthState();
}

class _TopMonthState extends State<TopMonth> {
  ...
  void load() async{
    ...
    if (response.statusCode == 200) {
      List<dom.Element> comics = html.parse(response.body).getElementById("tab-top-month").children;
